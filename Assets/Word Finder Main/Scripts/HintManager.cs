...
public class HintManager : MonoBehaviour
{
    ...
    List<int> letterIntGivenIndices = new List<int>();
    ...
    public void LetterHint(){
        ...
        if (letterIntGivenIndices.Count >= 5)
        return;

        List<int> letterHintNotGivenIndices = new List<int>();
        for (int i = 0; i < 5; i++)
        {
            if(!letterIntGivenIndices.Contains(i))
       ...
       letterIntGivenIndices.Add(randomIndex);
